...
<body class="restaurants-page">
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/RestaurantServlet"><i class="fa-solid fa-utensils"></i> Restaurants</a></li>
    ...
    <div style="padding: 40px 8% 0 8%;">
        ...
        <h1 style="font-size: 36px; font-weight: 800; color: #1A1615; margin: 0; text-align: left;">Browse Restaurants</h1>
    </div>
